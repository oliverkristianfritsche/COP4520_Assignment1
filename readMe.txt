...
As for the correctness of the design, the experimental evaluation I used for this approach was to first test using a smaller upperbound such as 10 or 100, this allowed me to easily compare my results to available data to determine the correctness of my implementation.
